---
title: "RESEARCH"
subtitle: "Examining the Impact of Smoking abns on mortality Rates: A Difference-in-Difference Analysis"
...
```{r}
sbl <- read.csv("C:/Users/adugy/Documents/R_Development_Code/RPackage/econ708_research/data/population_data.csv")

sbl_year <- read.csv("C:/Users/adugy/Documents/R_Development_Code/RPackage/econ708_research/data/states.csv")
```

mort_sbl = \beta_0 + \beta_1 * (SBL) + \beta_2 * (Z) + \epsilon

The above depicts the proposed regression model that corresponds to my setting and question showing the relationship between Maternal and Child Health (MCH) and Future Criminal Behavior (FCB). Adverse child experience (ACE), a back door threatens this identification strategy. I intend to control for it by adding it to the regression model. 
...
The dataset for this research was collected from the the below URL's.
1. 
